...
//    private bool connectFailed = false;
    ...
    private string url = "http://localhost/tcg/registration.php";
    private string url_login = "http://localhost/tcg/login.php";
    private string url_latest_cards = "http://localhost/tcg/latestcards.php";
    private string url_player_deck = "http://localhost/tcg/playerdecks.php";
    private string url_player_collection = "http://localhost/tcg/playercollection.php";
    public static string url_update_deck = "http://localhost/tcg/updatedeck.php";
