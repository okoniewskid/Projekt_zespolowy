...
//Klasa obslugujaca talie kart, operacje wykonywane na talii, tworzaca obiekty typu Card i skladajaca je z komponentow 
...
public class playerDeck : MonoBehaviour
{
    ...
    // metody odpowiadajace za "zlozenie" karty jako obiektu z komponentow
    ...
    public void LoadCardStats(card temp_card)
    {
        ...
        ManaColor colorless = MainMenu.DTA.settings.colors[0];
    ...
    public void AddArtAndText(card card_to_update, bool nocollider = false)
    {
        ...
        DbCard dbcard = MainMenu.DTA.cards.Where(x => x.id == card_to_update.Index).SingleOrDefault();
